...
mixin _$FormErrorState on _FormErrorState, Store {
  ...
  final _$dateAtom = Atom(name: '_FormErrorState.date');
  ...
  final _$telcelAtom = Atom(name: '_FormErrorState.telcel');
  ...
  final _$telfixAtom = Atom(name: '_FormErrorState.telfix');
  ...
  final _$sectorAtom = Atom(name: '_FormErrorState.sector');
  ...
  final _$cityAtom = Atom(name: '_FormErrorState.city');
  ...
  final _$stateAtom = Atom(name: '_FormErrorState.state');
